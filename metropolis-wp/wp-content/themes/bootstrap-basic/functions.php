...
wp_enqueue_style( 'style', get_template_directory_uri() . '/css/style.css', array('bootstrap.min'), '1.0.0', true );
wp_enqueue_style( 'carousel', get_template_directory_uri() . '/css/carousel.css', false, '', "all");
